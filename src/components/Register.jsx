    ...
    <div className="auth-wrapper">
      ...
      <div className="auth-card">
        ...
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Join Synapse and start connecting</p>
        </div>
        ...
        <form onSubmit={signupUser} noValidate>
          ...
          <div className="auth-form-group">
            <label className="auth-label" htmlFor="usernameInput">
              Username
            </label>
            <div className="auth-input-wrapper">
              ...
              <input
                ...
                className={`auth-input ${usernameTouched && !usernameValid ? "is-invalid" : ""}`}
                placeholder="johndoe"
                required
              />
            </div>
